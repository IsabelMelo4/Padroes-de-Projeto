class Enemy {
    ...
    constructor() {
        ...
        this.health = 200;
        this.deathEvent = new death_event(Event.DEATH_EVENT);
        this.deathEvent.addObservers(SoundManager.instance());

        this.ressuscitateEvent = new RessuscitateEvent(Event.RESSUSCITATE_EVENT)
        this.ressuscitateEvent.addObservers(SoundManager.instance());
